...
public class AllTasksFragment extends Fragment {
    ...
    private void loadTasks() {
        ...
        // Get grouped tasks from the database
        Map<String, List<Task>> groupedTasks = dataBaseHelper.getTasksGroupedByDate();
    ...
    private void shareTaskViaEmail(Task task) {
        // Prepare the task details to be shared
        ...
        emailIntent.setData(Uri.parse(mailto)); // This ensures only email apps handle this
